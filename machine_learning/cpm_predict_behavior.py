...
def predict_behavior(vectorized_connectivity_matrices, behavioral_scores,
    ...
    :param vectorized_connectivity_matrices:
    :param behavioral_scores:
    :param selection_predictor_method:
    :param significance_selection_threshold:
    :param confounding_variables:
    :param confounding_variables_kwarg:
    :return:
    """
