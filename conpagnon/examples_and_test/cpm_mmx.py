from conpagnon.data_handling import atlas, data_management
from conpagnon.utils.folders_and_files_management import load_object
import numpy as np
from nilearn.connectome import sym_matrix_to_vec, vec_to_sym_matrix
from patsy import dmatrix
from conpagnon.machine_learning.CPM_method import predict_behavior
...
kind = 'correlation'
patients_subjects_ids = list(subjects_matrices['controls'].keys())
# Patients matrices stack
patients_connectivity_matrices = np.array([subjects_matrices['controls'][s][kind] for
...
saving_directory = '/neurospin/grip/protocols/MRI/Gradient_hippocampe_AB_2017/CPM'
...
if __name__ == '__main__':
    for thresh in significance_selection_threshold:
        ...
        filename = 'controls_age_' + str(thresh) + '.pdf'
